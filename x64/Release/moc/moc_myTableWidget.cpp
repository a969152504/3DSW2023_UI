...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_myTableWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_myTableWidget_t qt_meta_stringdata_myTableWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_myTableWidget[] = {
...
Q_CONSTINIT const QMetaObject myTableWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_myTableWidget.offsetsAndSizes,
